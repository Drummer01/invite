  ...
  "node_modules/fslightbox-react/index.js"(exports, module) {
    (() => {
        ...
        window, e2.exports = function(e3) {
          ...
          function W(e4) {
            ...
            o3.className = "".concat(i, "nav"), n3.appendChild(o3), function(e5, t4) {
              ...
              n4.className = "".concat(i, "toolbar"), t4.appendChild(n4), function(e6, t5) {
                if (!e6.hfs) {
                  var n5 = "M4.5 11H3v4h4v-1.5H4.5V11zM3 7h1.5V4.5H7V3H3v4zm10.5 6.5H11V15h4v-4h-1.5v2.5zM11 3v1.5h2.5V7H15V3h-4z", o4 = O(t5);
                  o4.title = "Enter fullscreen";
                  var r2 = H(o4, "0 0 18 18", n5);
                  e6.fso = function() {
                ...
                var n5 = O(t5, "Close");
                n5.onclick = e6.core.lightboxCloser.closeLightbox, H(n5, "0 0 24 24", "M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z");
              }(e5, n4);
          ...
          function D(e4, t3, n3, o3) {
            ...
            s2.className = "".concat(f, " ").concat(f, "-").concat(n3), s2.title = "".concat(r2, " slide"), s2.onclick = t3, function(e5, t4) {
              ...
              n4.className = "fslightboxb ".concat(p, " ").concat(a), H(n4, "0 0 20 20", t4), e5.appendChild(n4);
          ...
          function Y(e4) {
            var t3 = this, n3 = e4.core, o3 = n3.globalEventsController, i2 = n3.scrollbarRecompensor, r2 = (e4.data, e4.e), s2 = e4.elements, c2 = e4.fs, a2 = e4.props, u2 = e4.sourcePointerProps, d2 = e4.ud;
            this.runActions = function() {
              t3.i = 1, s2.container.classList.add(v), o3.removeListeners(), a2.exitFullscreenOnClose && e4.ifs && c2.x(), setTimeout(function() {
                t3.i = 0, u2.isPointering = false, s2.container.classList.remove(v), document.documentElement.classList.remove(l), i2.removeRecompense(), d2 && s2.container.close(), document.body.removeChild(s2.container), r2("onClose");
              }, 270);
            };
          }
          function J(e4, t3) {
            ...
            this.props = { sources: [], customAttributes: [], customClasses: [], autoplays: [], types: [], videosPosters: [], exitFullscreenOnClose: 1, sourceMargin: 0.05, slideDistance: 0.3 }, this.data = { isFullscreenOpen: false, scrollbarWidth: 0 }, this.isl = [], this.sourcePointerProps = { downScreenX: null, isPointering: false, isSourceDownEventTarget: false, swipedX: 0 }, this.stageIndexes = {}, this.elements = { a: [], container: null, slideSwipingHoverer: null, smw: [], sourceWrappersContainer: null, sources: [], sourceAnimationWrappers: [] }, this.sn = function() {
              ...
              function x2() {
                ...
                b2 = true, function(e6) {
                  ...
                  e6.dss = t5.disableSlideSwiping, e6.loc = t5.loadOnlyCurrentSource, e6.ud = t5.useDialog && "function" == typeof HTMLDialogElement;
                ...
                }(), (r3 || s3.length > 0) && (e5.loc = 1), G(e5), e5.fs.i(), h2.container = document.createElement(e5.ud ? "dialog" : "div"), h2.container.className = "".concat(i, "container ").concat(c, " ").concat(g), h2.container.setAttribute("tabindex", "0"), function(e6) {
                  var t5 = e6.elements;
              ...
              e5.open = function() {
                ...
                }(e5), a2.updateStageIndexes(), b2 ? (v2.c(), v2.a(), v2.b(i2), v2.b(c2), v2.b(d2), f2("onShow")) : x2(), s2.displaySourcesWhichShouldBeDisplayed(), e5.sn(n4 + 1), document.body.appendChild(h2.container), e5.ud && h2.container.showModal(), h2.container.focus(), document.documentElement.classList.add(l), r2.addRecompense(), o3.attachListeners(), u2.runActions(), h2.smw[n4].n(), t3.p(n4), f2("onOpen");
              };
      ...
      (() => {
        ...
        var r, s = 0;
        function c(o2) {
          for (var i2 = (0, e2.useRef)(), c2 = [], a = (0, e2.useRef)(), l = (0, e2.useRef)(o2.toggler), u = 0; u < o2.sources.length; u++) c2[u] = (0, e2.useRef)();
          function d() {
            var e3 = o2.sourceIndex;
            void 0 === e3 && (e3 = o2.slide - 1), a.current.open(e3 || 0);
          }
          return t2().useInsertionEffect && t2().useInsertionEffect(function() {
            s || (r = n(913), s = 1);
          }, []), (0, e2.useEffect)(function(e3) {
            if (s || (r = n(913), s = 1), !a.current) {
              ...
              return Object.assign(t3.props, o2), t3.props.sources = o2.sources.map(function(e4, t4) {
                ...
                var n2 = c2[t4].current;
                return i2.current.removeChild(n2), n2.childElementCount > 1 ? n2 : n2.firstChild;
              }), t3.props.maxYoutubeDimensions = o2.maxYoutubeVideoDimensions, a.current = t3, void (o2.openOnMount && d());
            }
            o2.toggler != l.current && (l.current = o2.toggler, d());
          }, [o2.toggler]), !a.current && t2().createElement("div", { ref: i2, style: { display: "none" } }, o2.sources.map(function(e3, n2) {
            return "string" != typeof e3 && t2().createElement("div", { ref: c2[n2], key: n2 }, e3);
          }));
        }
        "object" === ("undefined" == typeof window ? "undefined" : i(window)) && (r = n(913), s = 1);
      })(), module.exports = o;
    })();
  }
});
